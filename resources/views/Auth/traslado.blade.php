@extends('layout.layout') @section('title','Traslados')@section('link')
<link rel="stylesheet" href="css/bootstrap.css">
<link rel="stylesheet" href="css/app.css">
<link rel="stylesheet" href="css/fontawesome-all.min.css"> @endsection @section('content')
<div class="container">
    <h1 class="text-uppercase mb-0 text-center">Traslados <i class="fas fa-plane"></i></h1>
    <hr class="star-light">
    <!-- ************************** Buscar Traslado ************************** -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Registro de traslado</h5>
                ...
                <div class="modal-body">
                    <form role="form" method="POST" action="">
                        ...
                        <div class="form-group">
                            <label for="Cuenta" class="col-form-label"> <span style="color:red;">*</span> Empleado:</label>
                            <input type="text" class="form-control" name="Cuenta" id="Cuenta">
                        </div>
                        <div class="form-group">
                            <label for="Abono" class="col-form-label"><span style="color:red;">*</span> Empresa que envia:</label>
                        ...
                        <div class="form-group">
                            <label for="Motivo" class="col-form-label"><span style="color:red;">*</span> Motivo traslado:</label>
                            <input type="text" class="form-control" name="Motivo" id="Motivb">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="Sucursal" class="col-form-label"><span style="color:red;">*</span> Sucursal:</label>
    ...
    <!-- ************************** Boton Modal Traslado ************************** -->
    <div class="row">
        <div class="col-md-3 col-ms-12 ">
            <!-- agregar margin-top: 0.5em; en sm y md -->
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Agregar registro de traslados <i class="fas fa-plus"></i></button>
        </div>
    </div>
