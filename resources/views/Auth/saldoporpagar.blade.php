@extends('layout.layout') @section('title','Saldo Por Pagar')@section('link')
<link rel="stylesheet" href="css/bootstrap.css">
<link rel="stylesheet" href="css/app.css">
<link rel="stylesheet" href="css/fontawesome-all.min.css"> @endsection @section('content')
<div class="container">
    <h1 class="text-uppercase mb-0 text-center">Saldo por pagar <i class="fas fa-money-bill-alt"></i></h1>
    <hr class="star-light">
    <!-- ************************** Buscar Saldo ************************** -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Registro de saldo por pagar</h5>
                ...
                <div class="modal-body">
                    <form role="form" method="POST" action="">
                        ...
                        <div class="form-group">
                            <label for="Cuenta" class="col-form-label"> <span style="color:red;">*</span> Cuenta:</label>
                            <input type="text" class="form-control" name="Cuenta" id="Cuenta">
                        </div>
                        <div class="form-group">
                            <label for="Abono" class="col-form-label"><span style="color:red;">*</span> Abono por pagar:</label>
        ...
        <table class="table">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th scope="col">Abono por pagar</th>
    ...
    <div class="row">
        <div class="col-md-3 col-ms-12 ">
            ...
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Agregar registro de saldo <i class="fas fa-plus"></i></button>
        </div>
    </div>
